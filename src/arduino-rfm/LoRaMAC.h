...
//ABP Function Def:
void LORA_Cycle(sBuffer *Data_Tx, sBuffer *Data_Rx, RFM_command_t *RFM_Command, sLoRa_Session *Session_Data, sLoRa_Message *Message_Rx, sSettings *LoRa_Settings);
...
//ABP Function Def:
void LORA_Receive_Data(sBuffer *Data_Rx, sLoRa_Session *Session_Data, sLoRa_Message *Message, sSettings *LoRa_Settings);
//OTAA Functionality:
